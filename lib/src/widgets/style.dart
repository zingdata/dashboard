...
class DashboardCursorState {
  ...
  // Edge-specific states for precise resizing guidance
  static const DashboardCursorState leftEdge = DashboardCursorState(
    SystemMouseCursors.resizeLeftRight,
    'Drag left edge to resize horizontally'
  );
  
  static const DashboardCursorState rightEdge = DashboardCursorState(
    SystemMouseCursors.resizeLeftRight,
    'Drag right edge to resize horizontally'
  );
  
  static const DashboardCursorState topEdge = DashboardCursorState(
    SystemMouseCursors.resizeUpDown,
    'Drag top edge to resize vertically'
  );
  
  static const DashboardCursorState bottomEdge = DashboardCursorState(
    SystemMouseCursors.resizeUpDown,
    'Drag bottom edge to resize vertically'
  );
  
  static const DashboardCursorState topLeftCorner = DashboardCursorState(
    SystemMouseCursors.resizeUpLeftDownRight,
    'Drag corner to resize diagonally'
  );
  
  static const DashboardCursorState topRightCorner = DashboardCursorState(
    SystemMouseCursors.resizeUpRightDownLeft,
    'Drag corner to resize diagonally'
  );
  
  static const DashboardCursorState bottomLeftCorner = DashboardCursorState(
    SystemMouseCursors.resizeUpRightDownLeft,
    'Drag corner to resize diagonally'
  );
  
  static const DashboardCursorState bottomRightCorner = DashboardCursorState(
    SystemMouseCursors.resizeUpLeftDownRight,
    'Drag corner to resize diagonally'
  );
  
  // Status messages for operations
  static const DashboardCursorState itemSelected = DashboardCursorState(
    SystemMouseCursors.basic,
    'Item selected'
  );
  
  static const DashboardCursorState resizing = DashboardCursorState(
    SystemMouseCursors.resizeLeftRight,
    'Resizing item'
  );
  
  static const DashboardCursorState resizeComplete = DashboardCursorState(
    SystemMouseCursors.basic,
    'Resize complete'
  );
  
  static const DashboardCursorState itemMoved = DashboardCursorState(
    SystemMouseCursors.basic,
    'Item placed in new position'
  );
}
